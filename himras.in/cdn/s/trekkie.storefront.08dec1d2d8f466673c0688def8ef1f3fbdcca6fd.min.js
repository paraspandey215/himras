    ...
    var e = {
                    ...
                    if (void 0 !== e) return function(e) {
                        ...
                        return "{" == t ? function(e) {
                            ...
                            if (s) {
                                ...
                                u = [8, 13, 18, 23].reduce(((e, t) => e.slice(0, t) + "-" + e.slice(t)), e)
                            }
            ...
            8680: function(e, t, n) {
                ...
                function d(e) {
                    ...
                    return {
                        query: `query { consentManagement { cookies(${a.objectToGraphQL(n)}) { trackingConsentCookie cookieDomain landingPageCookie origReferrerCookie } } }`,
                        variables: {}
                    }
                }
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    ...
                    return fetch(`https://${p}/api/unstable/graphql.json`, f).then((e => {
                        ...
                        const s = 31536e6,
                            d = 12096e5,
                            p = a.data.consentManagement.cookies.cookieDomain,
                            l = p || n.checkoutRootDomain || window.location.hostname,
                            f = n.storefrontRootDomain || p || window.location.hostname,
                            _ = a.data.consentManagement.cookies.trackingConsentCookie,
                            E = a.data.consentManagement.cookies.landingPageCookie,
                            h = a.data.consentManagement.cookies.origReferrerCookie;
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, l, s, _), E && h && (r.writeCookie(c, l, d, E), r.writeCookie(u, l, d, h)), f !== l && (r.writeCookie(i.CONSENT_COOKIE_NAME, f, s, _), E && h && (r.writeCookie(c, f, d, E), r.writeCookie(u, f, d, h))), o.dispatchEvents(e), void 0 !== t && t(null, a), a
                    })).catch((e => {
                ...
                var g = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return i(i({
                            ...
                            asset_version_id: "08dec1d2d8f466673c0688def8ef1f3fbdcca6fd",
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "08dec1d2d8f466673c0688def8ef1f3fbdcca6fd",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
                    ...
                    y = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "08dec1d2d8f466673c0688def8ef1f3fbdcca6fd",
